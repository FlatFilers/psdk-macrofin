...
export const Employees_BASELINE = new Sheet(
  'Employees BASELINE',
  {
    ...
    mobilephone: NumberField({
      label: 'Mobile Phone',
      description:
        'The information entered for this field can be in one of the following formats: 999-999-9999 (999) 999-9999 1-999-999-9999 1 (999) 999-9999 999-999-9999 ext 999 +44 (0) 1234-4567-568',
    }),

    officephone: NumberField({
      label: 'Office Phone',
      description:
        'The information entered for this field can be in one of the following formats: 999-999-9999 (999) 999-9999 1-999-999-9999 1 (999) 999-9999 999-999-9999 ext 999 +44 (0) 1234-4567-568',
    }),
    ...
    purchaseorderapprovallimit: TextField({
